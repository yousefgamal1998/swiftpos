    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-slate-800">Create Dashboard Card</h2>
            ...
            <form @submit.prevent="submit" class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4">
                    ...
                    <p class="mt-2 text-xs text-slate-500">
                        Upload a PNG, JPG, or WebP. If omitted, the dashboard will show a default placeholder.
                    </p>
                    ...
                    <div class="mt-3 flex flex-wrap items-center gap-3">
                        <div class="rounded-xl border border-slate-200 bg-white px-4 py-3">
                            ...
                            <img
                                :src="imagePreview ?? '/images/card-placeholder.svg'"
                                alt=""
